...
interface IEulerVault is IERC20Metadata {
    ...
    function LTVBorrow(IEulerVault collateral) external view returns (uint16);
    ...
    function LTVFull(IEulerVault collateral) external view returns (LTVFullData memory);
    ...
    function unitOfAccount() external view returns (IERC20Metadata);
