...
interface IMorpho {
    ...
    event AccrueInterest(MorphoMarketId indexed marketId, uint256 prevBorrowRate, uint256 interest, uint256 feeShares);
    event Borrow(
        MorphoMarketId indexed marketId, address caller, address indexed onBehalf, address indexed receiver, uint256 assets, uint256 shares
    );
    event CreateMarket(MorphoMarketId indexed marketId, MarketParams marketParams);
    ...
    event Repay(MorphoMarketId indexed marketId, address indexed caller, address indexed onBehalf, uint256 assets, uint256 shares);
    event SetAuthorization(address indexed caller, address indexed authorizer, address indexed authorized, bool newIsAuthorized);
    event SetFee(MorphoMarketId indexed marketId, uint256 newFee);
    event SetFeeRecipient(address indexed newFeeRecipient);
    event SetOwner(address indexed newOwner);
    event Supply(MorphoMarketId indexed marketId, address indexed caller, address indexed onBehalf, uint256 assets, uint256 shares);
    event SupplyCollateral(MorphoMarketId indexed marketId, address indexed caller, address indexed onBehalf, uint256 assets);
    event Withdraw(
        MorphoMarketId indexed marketId, address caller, address indexed onBehalf, address indexed receiver, uint256 assets, uint256 shares
    );
    event WithdrawCollateral(
        MorphoMarketId indexed marketId, address caller, address indexed onBehalf, address indexed receiver, uint256 assets
    );
...
interface IIrm {
    ...
    event BorrowRateUpdate(MorphoMarketId indexed marketId, uint256 avgBorrowRate, uint256 rateAtTarget);
