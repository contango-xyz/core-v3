...
interface IRewardsDistributor {
    ...
    function claimAllRewardsOnBehalf(address[] memory assets, address user, address to)
        external
        returns (address[] memory rewardsList, uint256[] memory claimedAmounts);
    function claimAllRewardsToSelf(address[] memory assets) external returns (address[] memory rewardsList, uint256[] memory claimedAmounts);
    ...
    function getRewardsByAsset(IAToken aToken) external view returns (address[] memory);
    function getRewardsData(IAToken aToken, address reward) external view returns (RewardsData memory);
