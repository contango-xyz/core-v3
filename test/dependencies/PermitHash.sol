...
import { IAllowanceTransfer, ISignatureTransfer } from "../../src/dependencies/permit2/IPermit2.sol";

// Slightly modified version of https://etherscan.deth.net/address/0x000000000022D473030F116dDEE9F6B43aC78BA3
library PermitHash {
    ...
    function hash(IAllowanceTransfer.PermitBatch memory permitBatch) internal pure returns (bytes32) {
        ...
        return keccak256(
            abi.encode(_PERMIT_BATCH_TYPEHASH, keccak256(abi.encodePacked(permitHashes)), permitBatch.spender, permitBatch.sigDeadline)
        );
    }
    ...
    function hash(ISignatureTransfer.PermitTransferFrom memory permit, address spender) internal pure returns (bytes32) {
        ...
        return keccak256(abi.encode(_PERMIT_TRANSFER_FROM_TYPEHASH, tokenPermissionsHash, spender, permit.nonce, permit.deadline));
    }
    ...
    function hashWithWitness(
        ...
        return keccak256(
            abi.encode(typeHash, keccak256(abi.encodePacked(tokenPermissionHashes)), spender, permit.nonce, permit.deadline, witness)
        );
    }
